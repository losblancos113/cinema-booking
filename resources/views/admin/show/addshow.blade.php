            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/show/addshow" method="POST">
                           ...
                           <div class="form-group">
                                ...
                                <input class="form-control" name="dateshow" placeholder="Nhập ngày chiếu" />
                            </div>
                             <div class="form-group">
                                <label>Giờ bắt đầu ( ví dụ 23:19:33 23 giờ 19 phút 33 giây)</label>
                                <input class="form-control" name="timeshow" placeholder="Nhập giờ chiếu" />
                            </div>
                            <div class="form-group">
                                <label>Giá vé  ( ví dụ 70000) </label>
                                <input class="form-control" name="amount" placeholder="Nhập giá vé" />
                            </div>
                            
                            <button type="submit" class="btn btn-default">Thêm kế hoạch chiếu</button>
